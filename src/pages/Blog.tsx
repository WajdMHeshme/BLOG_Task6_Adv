      ...
      <div className="flex flex-col md:grid md:grid-cols-[1fr_3fr] gap-8">
        <div className="space-y-6 order-1 md:order-[0]">
          ...
          {relatedPosts.map((related) => (
            <div
              key={related.id}
              className="p-2 cursor-auto transition-transform duration-300 ease-in-out transform hover:scale-[1.02] hover:shadow-lg hover:bg-gray-50 dark:hover:bg-darkTheme/40"
              data-aos="fade-right"
            >
              <img
